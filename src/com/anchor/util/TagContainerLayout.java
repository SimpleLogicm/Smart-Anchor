...
/***
 * Tag container view for explore page.Tag container have multiple tag view
 */
...
public class TagContainerLayout extends ViewGroup {
    ...
    private int rightDrawable = R.drawable.x;
    private int mTagPadding = 20;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        rightDrawable = attributes.getResourceId(R.styleable.AndroidTagView_tagDrawableRight, 0);
        mTagPadding = (int) attributes.getDimension(R.styleable.AndroidTagView_tag_padding, 0);
//        mTagTypeface = FontUtils.getFont(context,"fonts/Quicksand_Regular.otf");
        backgroundDrawable = attributes.getResourceId(R.styleable.AndroidTagView_tagBackground, 0);
        foregroundDrawable = attributes.getResourceId(R.styleable.AndroidTagView_tagForeground, 0);
        attributes.recycle();
...
//    }
    ...
    private void initTagView(TagView tagView) {
        ...
        tagView.setTagBackground(backgroundDrawable);
        tagView.setTagForeground(foregroundDrawable);
        ...
        tagView.setRightDrawable(rightDrawable);
        tagView.setPadding(mTagPadding);
