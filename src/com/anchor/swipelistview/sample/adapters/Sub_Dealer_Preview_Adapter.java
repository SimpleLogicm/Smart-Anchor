...
public class Sub_Dealer_Preview_Adapter extends ArrayAdapter<HashMap<String, String>>{
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.bAction1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                List<Local_Data> cont1 = dbvoc.Get_OrderProducts_BYITEM_NUMBER_SubDealer(getData.get(TAG_ITEM_NUMBER),Global_Data.GLOvel_SUB_GORDER_ID);
               ...
               /* if (isPlayStoreInstalled()) {
                ...
                alertDialog.setButton(Dialog.BUTTON_POSITIVE, "Yes",new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        dbvoc = new DataBaseHelper(context);
                        dbvoc.getDeleteTableorderproduct_byITEM_NUMBER_SUBDEALER(getData.get(TAG_ITEM_NUMBER),Global_Data.GLOvel_SUB_GORDER_ID);
