...
import com.anchor.adapter.Scheme_Adapter;
...
public class Customer_Schemes_New extends Activity implements Scheme_Adapter.UserAdapterListener, Scheme_Adapter.UserAdapterListenernew, DatePickerDialog.OnDateSetListener {
    private ProgressDialog dialog;
    private ShimmerRecyclerView recyclerView;
    Scheme_Adapter scheme_adapter;
    List<Scheme_Model> scheme_list = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer__schemes__new);
//
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        if (!Global_Data.Quantity_click_flag.equalsIgnoreCase("")) {
            Title_Text = "Scheme Shortfall(Ongoing)  " + " Quantity wise scheme   " + "Data as on ";
            ;
            type = "quantity";
        } else {
            Title_Text = "Scheme Shortfall(Ongoing)   " + " Value wise scheme   " + "Data as on ";
            ;
            type = "value";
        }
        ...
        try
        {
            ...
            SharedPreferences sp = Customer_Schemes_New.this.getSharedPreferences("SimpleLogic", 0);
...
//        scheme_list.add(new Scheme_Model("AEPL/WEEL","1842","1","CN","5","60","CN","2"));
        ...
        scheme_adapter = new Scheme_Adapter(getApplicationContext(), scheme_list, Customer_Schemes_New.this, Customer_Schemes_New.this);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getApplicationContext());
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.setAdapter(scheme_adapter);

        //  recyclerView.hideShimmerAdapter();

        sc_businees_unit_results.add("Business Unit");
        sc_businees_unit_adapter = new ArrayAdapter<String>(Customer_Schemes_New.this,
        ...
        Customer_Schemes_New.SpinnerInteractionListenerUnit listener = new Customer_Schemes_New.SpinnerInteractionListenerUnit();
        ...
        sc_businees_division_adapter = new ArrayAdapter<String>(Customer_Schemes_New.this,
        ...
        Customer_Schemes_New.SpinnerInteractionListenerdivision listener2 = new Customer_Schemes_New.SpinnerInteractionListenerdivision();
        ...
        sc_businees_category_adapter = new ArrayAdapter<String>(Customer_Schemes_New.this,
        ...
        Customer_Schemes_New.SpinnerInteractionListenerb_category listener3 = new Customer_Schemes_New.SpinnerInteractionListenerb_category();
        ...
        sc_businees_brand_adapter = new ArrayAdapter<String>(Customer_Schemes_New.this,
        ...
        Customer_Schemes_New.SpinnerInteractionListenerb_brand listener4 = new Customer_Schemes_New.SpinnerInteractionListenerb_brand();
        ...
        if (cd.isConnectingToInternet()) {
            ...
            Toast toast = Toast.makeText(Customer_Schemes_New.this, "You don't have internet connection.", Toast.LENGTH_LONG);
        ...
        button.setButtonEventListener(new ButtonEventListener() {
            ...
            public void onButtonClicked(int index) {
                ...
                if (scheme_list.size() > 0 && (index == 1 || index == 2)) {
                    ...
                    Toast toast = Toast.makeText(Customer_Schemes_New.this, "Record not exist.", Toast.LENGTH_LONG);
                    toast.setGravity(Gravity.CENTER, 0, 0);
                    toast.show();
                }
        ...
        scheme_period_value.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datePickerDialog = DatePickerDialog.newInstance(Customer_Schemes_New.this, Year, Month, Day);
    ...
    public void SchemeList_Result() {
        ...
        try {
            service_url = domain + "customer_schemes?email=" + Global_Data.CUSTOMER_EMAIL + "&start_date=" + scheme_period_value.getText().toString() + "&end_date=" + scheme_period_value2.getText().toString() + "&business_unit=" + URLEncoder.encode(business_unit, "UTF-8") + "&primary_category=" + URLEncoder.encode(Global_Data.target_product_cate_value, "UTF-8") + "&business_category=" + URLEncoder.encode(business_category, "UTF-8") + "&sub_category=" + URLEncoder.encode(business_brand, "UTF-8") + "&type=" + URLEncoder.encode(type, "UTF-8") + "&period_type=" + period_type;
        ...
        jsObjRequest = new StringRequest(service_url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                new Customer_Schemes_New.scheme_List_Task().execute(response);
    ...
    @Override
    public void onUserClicked(Scheme_Model Scheme_Model, int position) {
        requestStoragePermissionnew(Scheme_Model, position);
    }
                ...
                if (response_result.equalsIgnoreCase("User doesn't exist")) {
                    ...
                    Customer_Schemes_New.this.runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            Toast toast = Toast.makeText(Customer_Schemes_New.this, response_result, Toast.LENGTH_LONG);
                            toast.setGravity(Gravity.CENTER, 0, 0);
                            toast.show();
                    ...
                    update_At_Date = "";
                    JSONArray customer_scheme_shorfalls = response.getJSONArray("customer_scheme_shorfalls");
                    Log.i("volley", "response customer_scheme_shorfalls Length: " + customer_scheme_shorfalls.length());
                    Log.d("volley", "customer_scheme_shorfalls" + customer_scheme_shorfalls.toString());
                    ...
                    if (customer_scheme_shorfalls.length() <= 0) {
                        ...
                        for (int i = 0; i < customer_scheme_shorfalls.length(); i++) {

                            JSONObject jsonObject = customer_scheme_shorfalls.getJSONObject(i);

                            scheme_list.add(new Scheme_Model(isNotNullNotEmptyNotWhiteSpaceOnlyByJavaString(jsonObject.getString("scheme_name")), isNotNullNotEmptyNotWhiteSpaceOnlyByJavaString(jsonObject.getString("current_volume")), isNotNullNotEmptyNotWhiteSpaceOnlyByJavaString(jsonObject.getString("current_eligibility")), isNotNullNotEmptyNotWhiteSpaceOnlyByJavaString(jsonObject.getString("gift_detail")), isNotNullNotEmptyNotWhiteSpaceOnlyByJavaString(jsonObject.getString("gift_value")), isNotNullNotEmptyNotWhiteSpaceOnlyByJavaString(jsonObject.getString("short_volume_for_next_slab")), isNotNullNotEmptyNotWhiteSpaceOnlyByJavaString(jsonObject.getString("next_scheme_slab")), isNotNullNotEmptyNotWhiteSpaceOnlyByJavaString(jsonObject.getString("next_scheme_value"))));
                    ...
                    Customer_Schemes_New.this.runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            scheme_adapter.notifyDataSetChanged();
                        ...
                        if (report.areAllPermissionsGranted()) {
                            ...
                            try {
                                if (cd.isConnectingToInternet()) {
                                    ...
                                    {
                                        Update_Download_Count("SchemeShortfall","email");
                                    }
                                    else
                                    {
                                        Update_Download_Count("SchemeShortfall","download");
                                    }
                                }
...
//                var = folder.mkdir();
            ...
            final String filename = storageDir.toString() + "/" + "Scheme_Shortfall_Report" + ".csv";

            // show waiting screen
            CharSequence contentTitle = getString(R.string.app_name);
            final ProgressDialog progDailog = ProgressDialog.show(
                    Customer_Schemes_New.this, contentTitle, "wait...",
                    true);//please wait
            final Handler handler = new Handler() {
                ...
                public void handleMessage(Message msg) {
                    ...
                    if (option_flag.equalsIgnoreCase("gmail")) {
                        File yourFile = new File(storageDir, "Scheme_Shortfall_Report" + ".csv");
...
//        // now add all this to the document
    ...
    private void createTable(Document document)
        ...
        if (scheme_list.size() > 0) {
            ...
            for (int i = 0; i < scheme_list.size(); i++) {
                ...
                table.addCell(scheme_list.get(i).getCurrent_Volume());
                table.addCell(scheme_list.get(i).getCurrent_Eligibility());
                table.addCell(scheme_list.get(i).getGift_Detail());
                table.addCell(scheme_list.get(i).getGift_Value());
                table.addCell(scheme_list.get(i).getShort_Volumn_For_Next_Slab());
                table.addCell(scheme_list.get(i).getNext_Scheme_Slab());
                table.addCell(scheme_list.get(i).getNext_Scheme_Value());
    ...
    public void GenerateCSVCSV() throws IOException {
        {
            ...
            final String filename = folder.toString() + "/" + "Scheme_Shortfall_Report" + ".csv";

            // show waiting screen
            CharSequence contentTitle = getString(R.string.app_name);
            final ProgressDialog progDailog = ProgressDialog.show(
                    Customer_Schemes_New.this, contentTitle, "Generated...",
                    true);//please wait
            final Handler handler = new Handler() {
                @Override
                public void handleMessage(Message msg) {

                    File yourFile = new File(folder, "Scheme_Shortfall_Report" + ".csv");
            ...
            new Thread() {
                public void run() {
                    try {
                        ...
                        String[] entries = "Scheme Name#Current Volume#Current Eligibility#Gift Detail#Gift Value#Short Volumn For Next Slab#Next Scheme Slab#Next Scheme Value".split("#"); // array of your values
                        ...
                        if (scheme_list.size() > 0) {
                            for (int i = 0; i < scheme_list.size(); i++) {
                                ...
                                String s = scheme_list.get(i).getScheme_Name() + "#" + scheme_list.get(i).getCurrent_Volume() + "#" + scheme_list.get(i).getCurrent_Eligibility() + "#" + scheme_list.get(i).getGift_Detail() + "#" + scheme_list.get(i).getGift_Value() + "#" + scheme_list.get(i).getShort_Volumn_For_Next_Slab() + "#" + scheme_list.get(i).getNext_Scheme_Slab() + "#" + scheme_list.get(i).getNext_Scheme_Value();
    ...
    private void requestStoragePermissionnew(final Scheme_Model scheme_model, final int position) {
    ...
    public void download_schemes(String scheme_name) {
        ...
        jsObjRequest = new StringRequest(service_url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                new Customer_Schemes_New.scheme_Download_Task().execute(response);
                    ...
                    if (document_url.equalsIgnoreCase("")) {
                        ...
                        Customer_Schemes_New.this.runOnUiThread(new Runnable() {
                            public void run() {
                                ...
                                Toast toast = Toast.makeText(Customer_Schemes_New.this, "Scheme document not found.", Toast.LENGTH_LONG);
                                toast.setGravity(Gravity.CENTER, 0, 0);
                                toast.show();
...
//                    });
    ...
    public void onDestroy() {
        super.onDestroy();
        unregisterReceiver(onComplete5);
        hidePDialog();
    }
    ...
    public BroadcastReceiver onComplete5 = new BroadcastReceiver() {
    ...
    public void Update_Download_Count(String Module_name,String type) {
        ...
        jsObjRequest = new StringRequest(service_url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                new Customer_Schemes_New.Update_Dwonload_cound().execute(response);
