...
public class Target_Summary2 extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.target_summary2);
        ...
        ts2back = findViewById(R.id.ts2back);
        ...
        ts2back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i=new Intent(Target_Summary2.this, Target_Summary1.class);
        ...
        ts2more.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast toast = Toast.makeText(Target_Summary2.this,"You don't have internet connection.", Toast.LENGTH_LONG);
...
//            if (extras != null) {
        ...
        else
        {
            ...
            Intent i=new Intent(Target_Summary2.this, Target_REYC_Main.class);
            overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
            i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(i);
            finish();
                    ...
                    try{
                        ...
                        if(response_result.equalsIgnoreCase("Please provide all the data")) {
                            ...
                            if(targets.length() <= 0)
                            {
                                ...
                                Toast toast = Toast.makeText(Target_Summary2.this, "Target not found.", Toast.LENGTH_LONG);
                                toast.setGravity(Gravity.CENTER, 0, 0);
                                toast.show();
                            ...
                            else
                            {
                                for (int i = 0; i < targets.length(); i++) {
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            ci.monthgrpmore_str = jsonObject.getString("month") +" "+ jsonObject.getString("year");
                                        }
                                        else
                                        {
                                            ci.monthgrpmore_str = jsonObject.getString("month");
                                        }
                                    }
...
//                                            agen_total +=  (Double.valueOf(jsonObject.getString("achieved").toString()))/(Double.valueOf(jsonObject.getString("target").toString()));
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast toast = Toast.makeText(Target_Summary2.this, "Some server error occurred. Please Contact IT team.", Toast.LENGTH_LONG);
                    toast.setGravity(Gravity.CENTER, 0, 0);
                    toast.show();
