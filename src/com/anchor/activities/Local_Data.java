...
public class Local_Data {
    ...
    public  String getscheame_code(){return scheame_code;}
    ...
    public void setProductid(String product_idd) {
        this.product_id = product_idd;
    }

    public String getOrder_category_code_array() {
        return order_category_code_array;
    }

    public void setOrder_category_code_array(String order_category_code_array) {
        this.order_category_code_array = order_category_code_array;
    }
    ...
    String sche_code;
    String qualifying_qty;
    String sch_amount;
    String created_by;
    String modified_by;
    String sch_created_at;
    String sch_updated_at;
    ...
    public String getQualifying_qty() {
        return qualifying_qty;
    }

    public void setQualifying_qty(String qualifying_qty) {
        this.qualifying_qty = qualifying_qty;
    }
    ...
    public String getSch_created_at() {
        return sch_created_at;
    }

    public void setSch_created_at(String sch_created_at) {
        this.sch_created_at = sch_created_at;
    }

    public String getSch_updated_at() {
        return sch_updated_at;
    }

    public void setSch_updated_at(String sch_updated_at) {
        this.sch_updated_at = sch_updated_at;
    }
