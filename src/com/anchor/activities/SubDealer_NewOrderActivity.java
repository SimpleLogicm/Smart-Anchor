...
public class SubDealer_NewOrderActivity extends BaseActivity {
    int check=0;
    int checkb=0;
    int checkd=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sound = SubDealer_NewOrderActivity.this.getSharedPreferences("SimpleLogic", 0);
...
//			{
        ...
        adapter_state1 = new ArrayAdapter<String>(SubDealer_NewOrderActivity.this, R.layout.spinner_item, results1);
        ...
        Discount_Adapter = new ArrayAdapter<String>(SubDealer_NewOrderActivity.this, R.layout.spinner_item, Scheme_array);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() == MotionEvent.ACTION_UP) {
                    if(event.getRawX() >= (Product_Variant.getRight() - Product_Variant.getCompoundDrawables()[DRAWABLE_RIGHT].getBounds().width())) {
                        ...
                        View view = SubDealer_NewOrderActivity.this.getCurrentFocus();
                        if (view != null) {
        ...
        Product_Variant.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View arg1, int pos,
                ...
                Global_Data.hideSoftKeyboard(SubDealer_NewOrderActivity.this);
                ...
                if (Product_Variant.getText().toString().trim().equalsIgnoreCase("Multiselect")) {
                    ...
                    SubDealer_NewOrderActivity.this.overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                    ...
                    spnCategory.setAdapter(adapter_state1);
                    //spnCategory.setOnItemSelectedListener(SubDealer_NewOrderActivity.this);

                    adapter_state2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                    spnProduct.setAdapter(adapter_state2);
                    //spnProduct.setOnItemSelectedListener(SubDealer_NewOrderActivity.this);
        ...
        list_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if( Global_Data.array_of_pVarient.size() > 0)
                {
                    ...
                    Global_Data.Search_Category_name ="";
                    Global_Data.Search_BusinessCategory_name = "";
                    Intent i = new Intent(getApplicationContext(),Sub_Dealer_ProductList.class);
                    startActivity(i);
                }
                else
                {
...
//	        	                             }
        ...
        SharedPreferences spf=SubDealer_NewOrderActivity.this.getSharedPreferences("SimpleLogic",0);
...
//							 toast.show();
                            ...
                            .equalsIgnoreCase("Select Brand"))
                    {
                        ...
                        ArrayAdapter<String> adapter = new ArrayAdapter<String>(SubDealer_NewOrderActivity.this,
                                android.R.layout.simple_spinner_dropdown_item,
                                result_product);
                        Product_Variant.setThreshold(1);// will start working from
                        // first character
                    ...
                    else
                    {
                        ...
                        if (Check_Null_Value.isNotNullNotEmptyNotWhiteSpaceOnlyByJava(parent.getItemAtPosition(pos).toString().trim())) {
                            ...
                            Global_Data.Order_hashmap.clear();
                            Intent intent = new Intent(getApplicationContext(), Sub_Dealer_ProductList.class);
                            intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                            //startActivityForResult(intent,SIGNATURE_ACTIVITY);
                            SubDealer_NewOrderActivity.this.overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                            startActivity(intent);
        ...
        buttonAddMOre.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View b, MotionEvent event) {
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN)
                {
					...
					*/
                    if (spnCategory.getSelectedItem().toString().equalsIgnoreCase("Select Business Category")) {
                        Toast toast = Toast.makeText(SubDealer_NewOrderActivity.this,"Please Select Business Category", Toast.LENGTH_SHORT);
                        toast.setGravity(Gravity.CENTER, 0, 0);
                        toast.show();
                    }

                    else if (spnProduct.getSelectedItem().toString().equalsIgnoreCase("Select Brand")) {
                        Toast toast = Toast.makeText(SubDealer_NewOrderActivity.this,"Please Select Brand", Toast.LENGTH_SHORT);
                        toast.setGravity(Gravity.CENTER, 0, 0);
                        toast.show();
                    }

                    else if (Product_Variant.getText().toString().trim().equalsIgnoreCase("")) {
                        Toast toast = Toast.makeText(SubDealer_NewOrderActivity.this,"Please Select Variant", Toast.LENGTH_SHORT);
                        toast.setGravity(Gravity.CENTER, 0, 0);
                        toast.show();
                    }

                    else if (editTextQuantity.getText().toString().length() == 0) {
                        Toast toast = Toast.makeText(SubDealer_NewOrderActivity.this,"Please enter Quantity", Toast.LENGTH_SHORT);
                        toast.setGravity(Gravity.CENTER, 0, 0);
                        toast.show();
                    }

//					else if (spnScheme.getSelectedItem().toString().equalsIgnoreCase("Select Discount Type")) {
//						Toast toast = Toast.makeText(SubDealer_NewOrderActivity.this,"Please Select Discount Type", Toast.LENGTH_SHORT);
//						toast.setGravity(Gravity.CENTER, 0, 0);
//						toast.show();
//					}
                        ...
                        if(contacts1.size() <= 0)
                        {
                            Toast toast = Toast.makeText(SubDealer_NewOrderActivity.this,
...
//							  }
                            ...
                            if (Global_Data.GLOVEL_ORDER_REJECT_FLAG.equalsIgnoreCase("TRUE")) {
                                ...
                                if (contactsn.size() > 0) {
                                    //	Toast.makeText(SubDealer_NewOrderActivity.this, "You already add this item in order", Toast.LENGTH_SHORT).show();
                                    Toast toast = Toast.makeText(SubDealer_NewOrderActivity.this, "You already add this item in order", Toast.LENGTH_SHORT);
                                    toast.setGravity(Gravity.CENTER, 0, 0);
                                    toast.show();
                                } else {
                                    //Toast.makeText(getApplicationContext(), "Item add successfully", Toast.LENGTH_LONG).show();
                                    if (Global_Data.app_sound == true) {
                                        mpplayer = MediaPlayer.create(SubDealer_NewOrderActivity.this, R.raw.cheer_8k);
                                        mpplayer.stop();
                                    } else {
                                        if (Global_Data.sound_file.length() > 0) {
                                            //Toast.makeText(SubDealer_NewOrderActivity.this, "sndfile:"+Global_Data.sound_file, Toast.LENGTH_SHORT).show();
                                            //mpplayer = new MediaPlayer();
                                            try {
                                                if (mpplayer.isPlaying()) {
                                                    mpplayer.reset();
                                                }
                                                mpplayer = MediaPlayer.create(SubDealer_NewOrderActivity.this, Uri.parse(Environment.getExternalStorageDirectory().getPath() + "/Audio/" + Global_Data.sound_file));
////                                    mp.start();
                                    ...
                                    Toast toast = Toast.makeText(SubDealer_NewOrderActivity.this,"Item add successfully", Toast.LENGTH_SHORT);
                                    toast.setGravity(Gravity.CENTER, 0, 0);
                                    toast.show();
//									  loginDataBaseAdapter.insertOrderProducts("", "",  Global_Data.GLObalOrder_id, "", spnCategory.getSelectedItem().toString() , spnProduct.getText().toString() , Global_Data.order_variant , " " , spnScheme.getSelectedItem().toString() , " ", "", editTextQuantity.getText().toString() , Global_Data.variant_rr,editTextMRP.getText().toString(), price, "", "",Global_Data.order_retailer,discount_amount,Global_Data.GLOvel_ITEM_NUMBER,discount_type);//Reading all
                                ...
                                if (Global_Data.GLOvel_GORDER_ID.equalsIgnoreCase("")) {
                                    ...
                                    try
                                    {
                                        AppLocationManager appLocationManager = new AppLocationManager(SubDealer_NewOrderActivity.this);
                                        Log.d("Class LAT LOG","Class LAT LOG"+appLocationManager.getLatitude()+" "+ appLocationManager.getLongitude());
                                        Log.d("Service LAT LOG","Service LAT LOG"+Global_Data.GLOvel_LATITUDE+" "+ Global_Data.GLOvel_LONGITUDE);
                                        PlayService_Location PlayServiceManager = new PlayService_Location(SubDealer_NewOrderActivity.this);

                                        if(PlayServiceManager.checkPlayServices(SubDealer_NewOrderActivity.this))
                                        {
...
////                                    mp.start();
                                    ...
                                    //mpplayer.start();
                                    Toast toast = Toast.makeText(SubDealer_NewOrderActivity.this, "Item add successfully", Toast.LENGTH_LONG);
                                    toast.setGravity(Gravity.CENTER, 0, 0);
                                    toast.show();
        ...
        buttonPreviewOrder.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View b, MotionEvent event) {
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN)
                {
                    ...
                    if(Global_Data.GLOVEL_ORDER_REJECT_FLAG.equalsIgnoreCase("TRUE"))
                    {
                        Intent i=new Intent(SubDealer_NewOrderActivity.this, Status_Activity.class);
                    ...
                    else
                    {
                        if (!Global_Data.GLOvel_GORDER_ID.equalsIgnoreCase("")) {
                            ...
                            i.putExtra("new","new");
                            SharedPreferences sp = SubDealer_NewOrderActivity.this
...
//						Toast toast = Toast.makeText(SubDealer_NewOrderActivity.this, "Please Select Business Category", Toast.LENGTH_LONG);
//						toast.setGravity(Gravity.CENTER, 0, 0);
//						toast.show();
...
//
        ...
        spnScheme.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View arg1,
                ...
                //Toast.makeText(SubDealer_NewOrderActivity.this, "click appear.", Toast.LENGTH_SHORT).show();
                if (parent.getItemAtPosition(pos).toString()
...
//						//Toast.makeText(SubDealer_NewOrderActivity.this,"val:"+Global_Data.pname,Toast.LENGTH_SHORT).show();
//
//						Toast toast = Toast.makeText(SubDealer_NewOrderActivity.this,"val:"+Global_Data.pname, Toast.LENGTH_LONG);
//						toast.setGravity(Gravity.CENTER, 0, 0);
//						toast.show();
//					}
//					adapter_state2 = new ArrayAdapter<String>(SubDealer_NewOrderActivity.this,
//							R.layout.spinner_item, results);
//					adapter_state2
//							.setDropDownViewResource(R.layout.spinner_item);
//					spnProduct.setAdapter(adapter_state2);
//
////					adapter_state1 = new ArrayAdapter<String>(SubDealer_NewOrderActivity.this,
