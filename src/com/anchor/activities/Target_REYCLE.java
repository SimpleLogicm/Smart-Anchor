...
//            if (extras != null) {
        ...
        {
            Toast toast = Toast.makeText(Target_REYCLE.this,"You don't have internet connection.", Toast.LENGTH_LONG);
            toast.setGravity(Gravity.CENTER, 0, 0);
            toast.show();

            Intent i=new Intent(Target_REYCLE.this, Target_REYC_Main.class);
                    ...
                    try{
                        ...
                        if(response_result.equalsIgnoreCase("Please provide all the data")) {
                            ...
                            if(targets.length() <= 0)
                            {
                                ...
                                Toast toast = Toast.makeText(Target_REYCLE.this, "Target not found.", Toast.LENGTH_LONG);
                                toast.setGravity(Gravity.CENTER, 0, 0);
                                toast.show();
...
//                                            agen_total +=  (Double.valueOf(jsonObject.getString("achieved").toString()))/(Double.valueOf(jsonObject.getString("target").toString()));
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast toast = Toast.makeText(Target_REYCLE.this, "Some server error occurred. Please Contact IT team.", Toast.LENGTH_LONG);
                    toast.setGravity(Gravity.CENTER, 0, 0);
                    toast.show();
