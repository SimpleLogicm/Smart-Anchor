...
import com.anchor.swipelistview.sample.adapters.Previous_orderEdit_Adapter;
...
public class Previous_orderNew_S2 extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_previous_order_new_s2);
        ...
        buttonPreviewCheckout.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View b, MotionEvent event) {
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN)
                {
                    ...
                    {
                        final Dialog dialog = new Dialog(Previous_orderNew_S2.this);
...
//                        }
                        ...
                        dataDistrubutorsAdapter = new ArrayAdapter<String>(Previous_orderNew_S2.this,android.R.layout.simple_spinner_item,Distributer_list);
                        ...
                        dialogButtonOk.setOnClickListener(new OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (spnDistributor.getSelectedItem().toString().equalsIgnoreCase("Select distributor")) {
                                    ...
                                    Previous_orderNew_S2.this.overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
...
//				}
    ...
    public void onBackPressed() {
        //if(statusOrderActivity.equalsIgnoreCase("previous")){
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(Previous_orderNew_S2.this).create(); //Read Update
            alertDialog.setTitle("Warning");
            alertDialog.setMessage(" Are you sure you want to move previous page?");
            alertDialog.setButton(Dialog.BUTTON_POSITIVE, "Yes",new DialogInterface.OnClickListener() {
