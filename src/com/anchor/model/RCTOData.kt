...
data class RCTOData(var id: String,var code: String,val user_name:String, var shop_name: String, var address: String,
                    ...
                    var distance: String,var address_line2: String,var landmark: String,var full_address : String,var dist_code:String,var dist_name:String,var is_approved:String,var bucket_name:String)