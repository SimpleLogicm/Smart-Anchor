...
public class Location_settings implements
        ConnectionCallbacks,
...
//    protected TextView mLongitudeTextView;
        ...
        switch (status.getStatusCode()) {
            ...
            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                ...
                try {
                    ...
                    // in onActivityResult().
                    status.startResolutionForResult((Activity) c_context, REQUEST_CHECK_SETTINGS);
    ...
    protected void startLocationUpdates() {
        if (ActivityCompat.checkSelfPermission(c_context, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(c_context, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
...
//                    mLastUpdateTime));
    ...
    public void onLocationChanged(Location location) {
        ...
        mLastUpdateTime = DateFormat.getTimeInstance().format(new Date());
//        updateLocationUI();
//        Toast.makeText(MainActivity.this, "location change",
