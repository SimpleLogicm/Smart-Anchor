...
public class DataProvider_City extends ContentProvider{
    ...
    public Cursor query(@NonNull Uri uri, String[] projections, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (sUriMatcher.match(uri)){
            case 1:
                mCursor = db.query(ContentProviderData_City.Dictionary.TABLE_NAME, projections, selection, selectionArgs, null, null, null);
                break;
            case 2:
                // selection = selection + ContentProviderData_City.Dictionary.code + " = " + selectionArgs;
                mCursor = db.query(ContentProviderData_City.Dictionary.TABLE_NAME, projections, selection, selectionArgs, null, null, null);
                break;
            default:
    ...
    public Uri insert(Uri uri, ContentValues contentValues) {
        ...
        long rowId = db.insert(ContentProviderData_City.Dictionary.TABLE_NAME, null, contentValues);
        if(rowId > 0) {
            Uri articleUri = ContentUris.withAppendedId(ContentProviderData_City.CONTENT_URI, rowId);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch(sUriMatcher.match(uri)) {
            case 1:
                count = db.delete(ContentProviderData_City.Dictionary.TABLE_NAME, selection, selectionArgs);
                break;
            case 2:
                String rowId = uri.getPathSegments().get(1);
                count = db.delete(ContentProviderData_City.Dictionary.TABLE_NAME, ContentProviderData_City.Dictionary.CITY + " = " + rowId
    ...
    public int update(Uri uri, ContentValues contentValues, String selection, String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)){
            case 1:
                count = db.update(ContentProviderData_City.Dictionary.TABLE_NAME, contentValues, selection, selectionArgs);
                break;
            case 2:
                String rowId = uri.getPathSegments().get(1);
                count = db.update(ContentProviderData_City.Dictionary.TABLE_NAME, contentValues, ContentProviderData_City.Dictionary.CITY + " = " + rowId +
